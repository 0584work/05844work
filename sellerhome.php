...
<h3 class="center01 m-3">ยินดีต้อนรับ , <?php echo $row['username'];?></h3>


<div class="container text-center center01">
	<div class="row row-cols-2 center01" style="width: 30rem;">
	<a href="customerdetail_se.php" role="button" class="btn btn-primary margin01 col " style="width: 12rem; margin-bottom:10px;">แสดงข้อมูลลูกค้า</a>
